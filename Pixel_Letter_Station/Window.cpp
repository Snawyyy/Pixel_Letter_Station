	...
	switch (uMsg)
	{
		...
		case WM_COMMAND: // Button logic
		{
			...
			case 6:
			{
				...
				CreateLetterWindow(hWnd, hInstance, 100, 100, LETTER_BOX_WIDTH + (SMALL_MARGIN * 2) + (BAR_MARGIN * 2) - 1 + (SMALL_MARGIN * 2), height - (MARGIN * 5.5) + WIN_BAR_SIZE + BAR_MARGIN + (SMALL_MARGIN * 2));
				break;
			}
			}
		}
